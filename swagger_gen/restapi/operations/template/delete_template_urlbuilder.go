...
func (o *DeleteTemplateURL) Build() (*url.URL, error) {
	...
	var _path = "/templates/{templateKey}"

	templateKey := o.TemplateKey
	if templateKey != "" {
		_path = strings.Replace(_path, "{templateKey}", templateKey, -1)
	} else {
		return nil, errors.New("templateKey is required on DeleteTemplateURL")
	}
