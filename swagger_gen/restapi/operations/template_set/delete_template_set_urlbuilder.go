...
func (o *DeleteTemplateSetURL) Build() (*url.URL, error) {
	...
	if setKey != "" {
		...
		return nil, errors.New("setKey is required on DeleteTemplateSetURL")
	}
...
func (o *DeleteTemplateSetURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteTemplateSetURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteTemplateSetURL")
	}
